...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'webapp_recording', (
            ...
            ('file_ID', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ...
            ('locations', self.gf('jsonfield.fields.JSONField')()),
        ))
        ...
        db.create_table(u'webapp_user', (
            ...
            ('user_ID', self.gf('django.db.models.fields.CharField')(default=UUID('669d29af-32fb-480c-8170-076f8abc6bcc'), unique=True, max_length=100, blank=True)),
    ...
    models = {
        ...
        u'webapp.recording': {
            ...
            'file_ID': ('django.db.models.fields.CharField', [], {'max_length': '36', 'primary_key': 'True'}),
            'file_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'webapp.user': {
            ...
            'user_ID': ('django.db.models.fields.CharField', [], {'default': "UUID('9904ea96-6959-400c-b79f-035a19b7f15f')", 'unique': 'True', 'max_length': '100', 'blank': 'True'}),
